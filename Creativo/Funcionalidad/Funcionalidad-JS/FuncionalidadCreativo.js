...
document.getElementById('editarOTLiderProyecto').addEventListener('click', function() {
    ...
    if (!enModoEdicion) {
        ...
        $.ajax({
            url: '../../../Creativo/Funcionalidad/BackendCreativos/actualizarOTCreativos.php',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
